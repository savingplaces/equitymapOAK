...
/////////////////Add Population Census Tract Data//////////////////////////
        ...
        var popTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/aachaf_oakland_tract10_select/FeatureServer",
          maxScale: 0,
          minScale: 0,   
...
/**************************Add Non-Study Census Tracts******************************/
        ...
        var nonStudyTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/OAK_NonStudy_Tracts/FeatureServer",
          maxScale: 0,
          minScale: 0,
          opacity: 1,
          renderer: {  
...
/**************************Add HAAN Tracts******************************/
        ...
        var Haan = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_HAAN/FeatureServer",
          maxScale: 0,
          minScale: 0,
          visible: true,     
          legendEnabled: true,    
...
/**************************Add HTC Project Points******************************/
        ...
        var htcProj = new FeatureLayer ({
            ...
            definitionExpression: "city = 'Oakland' AND state = 'CA' AND part3 >= '2009-01-01 00:00:00' AND part3 <= '2016-12-31 00:00:00'",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            popupEnabled: true, 
...
/**************************Add Local HDs******************************/
        ...
        var localHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Local_Historic_Districts/FeatureServer",   
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add NRHP Sites******************************/
        ...
        var nrhpSites = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/OAK_NRHP_Sites/FeatureServer",
...
/**************************Add NRHP HDs******************************/
        ...
        var nrhpHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_National_Register_Historic_Districts/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add Public Transportation Stations Layer******************************/
       ...
       const ctaLabel = {    
        ...
        var ctaStations = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/BART_Stations/FeatureServer",
            maxScale: 0,
            minScale: 100000,
            legendEnabled: true,
            visible: false,
        ...
        const ctaRenderer = {
          ...
          field: "descriptio",
          legendOptions: {
            title: "BART Line Name"
          },
          //defaultSymbol: { type: "simple-fill" },  
          uniqueValueInfos: [{
            value: "Antioch - SFIA/Millbrae",
            symbol: groupAntioch,
            label: "Antioch - SFIA/Millbrae"
          }, {
            value: "Fremont - Richmond",
            symbol: groupFremont,
            label: "Fremont - Richmond"
          }, {
            value: "Fremont - Daly City",
            symbol: groupFreDal,
            label: "Fremont - Daly City"
          }, {
            value: "Richmond - Daly City/Millbrae",
            symbol: groupRichDal,
            label: "Richmond - Daly City/Millbrae"
          }, {
            value: "Dublin/Pleasanton - Daly City",
            symbol: groupDubPleas,
            label: "Dublin/Pleasanton - Daly City"
          }, {
            value: "Coliseum - Oakland Airport",
            symbol: groupColiseum,
            label: "Coliseum - Oakland Airport"
          }],
        };
    
        
        var ctaLines = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/BART_Lines/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
        ...
        var collUniv = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Colleges_and_Universities/FeatureServer",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            legendEnabled: true,
       ...
       const demoRenderThree = {
        ...
        var demoPermits = new FeatureLayer ({
           url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/OAK_Demo_Permits/FeatureServer",
           ...
           popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid;'><td align='center' style='padding:2px'><h3>Demolition Permit</h3></td></tr></tbody></table>"+"<table style='border:2px solid #d1d1d1; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='center' colspan='2' style='background-color: #d8cebc ;padding:5px'><b><h4>Permit Information</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Type</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>Demolition</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Issue Date</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{FileDate}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Address</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{Address1}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Description</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{Desc_}</h6></td></tr></tbody></table><br>"
                }
        });
...
/****************************Red Line Data*************************/
        ...
        var redLine = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Redline/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
...
/**************************Add Neighborhood Boundaries******************************/
        ...
        var allNeighbor = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Neighborhoods/FeatureServer", 
          maxScale: 0,
          minScale: 0,
          opacity: 1,    
          legendEnabled: true,
        ...
        var cityLimits = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Boundary/FeatureServer",
          legendEnabled: false,
          visible: true,
          maxScale: 0,
          minScale: 0,
...
/***********************Search Widgets************************/
        ...
        var localHdSearch = new Search({
                ...
                sources: [
                    {
                        layer: localHd,
                        searchFields: ["DISCRIPTIO"],
                        displayField: "DISCRIPTIO",
                        exactMatch: false,
